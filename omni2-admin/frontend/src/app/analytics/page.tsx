    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex items-center gap-6 ml-8">
                ...
                <Link href="/analytics" className="text-sm font-medium text-purple-600 border-b-2 border-purple-600 pb-1">
                  Analytics
                </Link>
              </div>
            </div>
      ...
      <main className="p-6 max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Comprehensive analytics for your MCP infrastructure</p>
        </div>

        <div className="bg-white rounded-xl p-12 text-center border border-gray-200">
          <div className="text-6xl mb-4">📊</div>
          <h3 className="text-2xl font-bold text-gray-900 mb-2">Coming Soon</h3>
          <p className="text-gray-600 mb-6">Advanced analytics dashboard is under development</p>
